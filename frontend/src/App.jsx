        ...
        <div className="main-content">
          {mode === 'backtest' ? (
            <>
              ...
              <p className="subtitle">Historical simulation over the selected date range.</p>
              ...
              {results && (
                <>
                  <div className="metrics-grid">
                    <MetricCard title="Total Return" value={results.metrics.total_return_pct} suffix="%" isColorCoded />
                    <MetricCard title="CAGR" value={results.metrics.cagr_pct} suffix="%" isColorCoded />
                    <MetricCard title="Max Drawdown" value={results.metrics.max_drawdown_pct} suffix="%" isColorCoded />
                    <MetricCard title="Win Rate" value={results.metrics.win_rate_pct} suffix="%" />
                    <MetricCard title="Sharpe Ratio" value={results.metrics.sharpe_ratio} isColorCoded />
                    <MetricCard title="Total Trades" value={results.metrics.total_trades} />
                  </div>
                  ...
                  <div className="section-block">
                    <h2>Equity Curve</h2>
                    <p className="section-desc">Portfolio value over the backtest window.</p>
            ...
            <>
              <h1>Live Trading</h1>
              <p className="subtitle">Event-driven execution against OANDA paper trading.</p>
              <div className="empty-state">
                <div className="empty-icon">⚡</div>
                Live execution ships in Phase 5–7 of the V2 roadmap. Switch back to Backtest to
