...
print(sma_results[sma_results['signal'] != 0][['time', 'close', 'sma_short', 'sma_long', 'position', 'signal']].head())
...
print(bb_results[bb_results['signal'] != 0][['time', 'close', 'lower_band', 'upper_band', 'position']].head())
